...
import com.area.Tools.CharacterParserUtil;
import com.area.Tools.CountryComparator;
import com.area.Tools.CountrySortAdapter;
import com.area.Tools.CountrySortModel;
import com.area.Tools.GetCountryNameSort;
import com.area.Tools.ListViewUtility;
import com.area.Tools.SideBar;
import com.area.Tools.SideBar.OnTouchingLetterChangedListener;
...
public class CountryActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listView = (ListView) findViewById(R.id.country_lv_listhot);
    ...
    private void initView() {
        ...
        ListViewUtility.setListViewHeightBasedOnChildren(country_lv_countryList);
    }
